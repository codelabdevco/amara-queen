  ...
  if (user) {
    return (
      <>
        ...
        >
          <div className="w-7 h-7 rounded-full bg-gold/10 border border-gold/[0.1] flex items-center justify-center">
      ...
      <AnimatePresence>
        {showModal && (
          ...
          >
            ...
            <motion.div
              className="relative bg-[#2a1215] border border-white/[0.04] rounded-2xl p-6 w-full max-w-[320px] space-y-4"
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                <input
                  ...
                  className="w-full bg-[#1e0c0c] border border-white/[0.06] rounded-lg px-3 py-2.5 text-sm text-white placeholder:text-white/20 focus:border-gold/30 outline-none"
                />
                <input
                  type="password"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-2.5 rounded-lg bg-gold/10 text-gold border border-gold/[0.1] text-sm font-medium hover:bg-gold/20 transition-colors disabled:opacity-50"
                >
