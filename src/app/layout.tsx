        ...
        <svg style={{ position: "absolute", width: 0, height: 0 }} xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            <symbol id="fl-c" viewBox="0 0 200 56" preserveAspectRatio="none">
              ...
              <rect x="1" y="1" width="198" height="54" rx="1" fill="none" stroke="#8B7A4A" strokeWidth="1.1"/>
              <rect x="5" y="5" width="190" height="46" rx=".5" fill="none" stroke="#5A4E34" strokeWidth=".4"/>
            ...
            <symbol id="fl-g" viewBox="0 0 200 56" preserveAspectRatio="none">
              ...
              <rect x="1" y="1" width="198" height="54" rx="1" fill="none" stroke="#5A4015" strokeWidth="1.1"/>
              <rect x="5" y="5" width="190" height="46" rx=".5" fill="none" stroke="rgba(60,40,10,.3)" strokeWidth=".4"/>
