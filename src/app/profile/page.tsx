      ...
      >
        ...
        {loading ? (
          ...
          <div className="text-center mt-10 space-y-4">
            <div className="w-20 h-20 rounded-full bg-gold/10 border border-gold/[0.05] flex items-center justify-center mx-auto">
          ...
          <>
            ...
            {data.zodiac && (
              ...
              >
                ...
                <div className="bg-[#2a1215] border border-gold/[0.02] rounded-xl p-3.5">
            ...
            >
              ...
              <div className="bg-[#2a1215] border border-gold/[0.02] rounded-xl p-4 space-y-3">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-2.5 rounded-xl bg-gold/10 text-gold border border-gold/[0.05] text-sm font-medium hover:bg-gold/20 transition-colors"
              >
                แก้ไขข้อมูล
              </button>
              <button
...
function StatBox({ label, value }: { label: string; value: string }) {
  return (
    <div className="bg-[#2a1215] border border-gold/[0.02] rounded-xl p-3 text-center">
...
function InfoCard({ label, value, sub }: { label: string; value: string; sub?: string }) {
  return (
    <div className="bg-[#2a1215] border border-gold/[0.02] rounded-xl p-2.5 text-center">
