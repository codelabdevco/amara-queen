      ...
      <main className="flex-1 ml-56 p-8">
        ...
        {loading ? (
          ...
          <div className="bg-[#0c0d14] border border-white/[0.06] rounded-xl overflow-hidden">
            {/* Header */}
            <div className="grid grid-cols-[1.2fr_1.5fr_1fr_1fr_0.8fr_0.8fr] gap-3 px-5 py-3 border-b border-white/[0.06] text-xs text-white/30 uppercase tracking-wider">
              <span>วันที่</span>
              <span>ผู้ใช้</span>
              <span>วิธีชำระ</span>
            ...
            {transactions.map((t) => {
              ...
              return (
                <div
                  key={t.id}
                  className="grid grid-cols-[1.2fr_1.5fr_1fr_1fr_0.8fr_0.8fr] gap-3 px-5 py-3 border-b border-white/[0.04] text-sm hover:bg-white/[0.02] transition-colors items-center"
                >
