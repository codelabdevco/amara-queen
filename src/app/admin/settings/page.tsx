          ...
          <div className="max-w-2xl space-y-6">
            ...
            <div className="bg-[#111111] rounded-xl p-5">
              ...
              <textarea
                ...
                rows={10}
                className="w-full bg-[#0a0a0a] rounded-lg px-3 py-2.5 text-white text-sm font-mono leading-relaxed focus:border-gold/10 outline-none transition-colors resize-y"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-[#111111] rounded-xl p-5">
                ...
                <input
                  ...
                  className="w-full bg-[#0a0a0a] rounded-lg px-3 py-2 text-white text-sm focus:border-gold/10 outline-none transition-colors"
                />
              </div>
              <div className="bg-[#111111] rounded-xl p-5">
                <label className="block text-white/50 text-xs mb-2 uppercase tracking-wider">
            ...
            <div className="bg-[#111111] rounded-xl p-5">
              ...
              {settings.omisePublicKey && (
                <div className="mb-3">
                  ...
                  <p className="text-white/60 text-sm font-mono bg-[#0a0a0a] rounded-lg px-3 py-2">
              ...
              <div>
                ...
                <div
                  className="flex items-center gap-2 bg-[#0a0a0a] rounded-lg px-3 py-2 cursor-pointer hover:border-gold/10 transition-colors"
                  onClick={() => {
                  ...
                  {settings.creditPackages.map((pkg, i) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <span className="text-[#d4af37] font-semibold">{pkg.credits}</span>
            ...
            <button
              onClick={handleSave}
              disabled={saving}
              className="bg-gold/10 text-[#d4af37] rounded-lg px-6 py-2.5 text-sm font-medium hover:bg-gold/20 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
            >
