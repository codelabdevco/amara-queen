  ...
  return (
    <div className="flex">
      ...
      <main className="flex-1 ml-56 p-8">
        ...
        {/* Manual add credits */}
        <div className="bg-[#2a1215] border border-gold/[0.02] rounded-xl p-5 mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg bg-gold/10 text-gold border border-gold/[0.05] text-sm font-medium hover:bg-gold/20 transition-colors disabled:opacity-30"
            >
          ...
          {tabs.map((t) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm transition-colors ${
                tab === t.key
                  ? "bg-gold/10 text-gold border border-gold/[0.05]"
        ...
        {loading ? (
          ...
          <div className="bg-[#2a1215] border border-gold/[0.02] rounded-xl p-10 text-center text-white/20 text-sm">
            ไม่มีรายการ
          </div>
        ) : (
